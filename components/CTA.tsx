  ...
  return (
    <section>
      <div className="mx-auto max-w-300 px-4 sm:px-6 lg:px-20">
        <div className="relative my-8 overflow-hidden rounded-3xl bg-linear-to-br from-blue-600 to-blue-800 px-8 py-12 text-white shadow-xl shadow-blue-600/20 lg:px-16">
