...
export const LiquidGlassCard = ({
  ...
  // Create the MotionComponent based on props
  const MotionComponent = draggable || expandable ? motion.div : "div";

  // Build motion props separately
  ...
  if (draggable || expandable) {
    if (expandable) {
      motionProps.variants = {
        collapsed: {
          ...
          transition: {
            duration: 0.4,
            ease: "easeInOut", // Changed to string easing
          },
        },
        expanded: {
    ...
    if (draggable) {
      ...
      motionProps.dragElastic = 0.3;
      motionProps.dragTransition = {
        bounceStiffness: 300,
        bounceDamping: 10,
        power: 0.3,
      };
      motionProps.whileDrag = { scale: 1.02 };
    }

    // Add common hover/tap animations
